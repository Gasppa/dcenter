...
class PayloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payload" do
    assert_difference('Payload.count') do
      post payloads_url, params: { payload: { store_id: @payload.store_id, title: @payload.title } }
    end
  ...
  test "should update payload" do
    patch payload_url(@payload), params: { payload: { store_id: @payload.store_id, title: @payload.title } }
